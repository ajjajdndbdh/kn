...
- **Waktu:** 2026-08-25 17:42:44
- **Mode:** `full`  ·  **Durasi total:** 362s  ·  **Pekerja statik:** 2
...
| config_wiring SELF-TEST (bukti-merah guardrail) | PASS (10s) |
...
| guard:warehouse_scope SELF-TEST (E4.1, gudang khusus badan usaha) | PASS (0s) |
| guard:numeric_bounds (INV-NUM-01, statik+runtime) | PASS (1s) |
| seed_realistic (data uji bersih) | PASS (14s) |
...
| audit_doc_refs (INV-REF cakupan data + kesehatan tautan) | PASS (0s) |
...
| POC FASE D (makloon rantai proses) | PASS (5s) |
