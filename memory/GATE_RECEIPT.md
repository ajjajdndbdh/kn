...
- **Waktu:** 2026-08-25 16:48:49
- **Mode:** `full`  ·  **Durasi total:** 364s  ·  **Pekerja statik:** 2
...
| guard:list_export (INV-UI-07, daftar berhalaman wajib bisa diunduh) | PASS (0s) |
...
| guard:escape_layers (INV-UI-10, Esc menutup lapisan teratas saja) | PASS (0s) |
...
| audit_doc_refs (INV-REF cakupan data + kesehatan tautan) | PASS (2s) |
...
| audit_entity_isolation (E0.9/E0.10 — 0 kebocoran lintas-entitas) | PASS (6s) |
...
| guard:status_history SELF-TEST (bukti-merah bentuk riwayat ke-dua) | PASS (1s) |
...
| guard:qty_dual SELF-TEST (bukti-merah dua satuan, 32 kasus dua arah) | PASS (1s) |
